...
This guide covers the practical steps for connecting tools to a running workflow. For background on tool source types, the MCP Server Registry, transport configuration, and taint tracking, see [Tools & MCP](/docs/concepts/tools-and-mcp/).
...
Once built, [register your server's transport configuration](/docs/concepts/tools-and-mcp/#registering-servers) in the MCP Server Registry and reference it from your agent configurations.
