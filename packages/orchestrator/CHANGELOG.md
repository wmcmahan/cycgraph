...
- 3c3a6a8: Token accounting and budgets now count billing-equivalent tokens. The
...
- ce05189: Anthropic prompt caching now actually hits. The previous release
...
- d03d061: Multi-step agent executions on Anthropic now advance a prompt-cache
...
- d03d061: When a provider's aggregate usage promise reports nothing usable, the
