 ...
 *
 * @module execution/nodes/reflection
 */

import { v4 as uuidv4 } from 'uuid';

import type { GraphNode, ReflectionConfig } from '../../graph/graph.js';
import type { Action, StateView } from '../../state/state.js';
import type { MemoryWriter, MemoryWriterFact } from '../../memory/memory-writer.js';
import { createLogger } from '../../observability/logger.js';
import { sanitizeString } from '../../agents/executors/agent/sanitizers.js';
