 ...
 *
 * @module execution/nodes/evolution
 */

import type { GraphNode } from '../../graph/graph.js';
import type { Action, StateView } from '../../state/state.js';
import { executeParallel, type ParallelTask } from '../engine/parallel-executor.js';
...
import { LESSON_PROVENANCE_KEY } from '../../memory/lesson-provenance.js';
...
import { aggregateParallelTaint } from '../../security/taint.js';
