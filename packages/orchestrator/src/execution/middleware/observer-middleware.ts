 ...
 * ```
 *
 * @module execution/middleware/observer-middleware
 */

import type { GraphRunnerMiddleware } from '../middleware/middleware.js';
...
async function runDiagnosticAgent(
  ...
  const { createProviderRegistry } = await import('../../agents/providers/provider-registry.js');
