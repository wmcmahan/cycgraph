...
Extraction efficacy evaluation for `@cycgraph/memory` — the adversarial harness the extraction tier previously lacked. Three corpus partitions with distinct roles:
